  const programming = {
    ...
    buttonText: "Help us Succeed",
    buttonLink: 'https://www.paypal.com/cgi-bin/webscr?cmd=_donations&business=info@codigoecuador.com&item_name=Imagina%20C%C3%B3digo%20Ecuador&currency_code=USD',
    image: "https://theadelantemovement.com/wp-content/uploads/2016/05/22543243101_46a15d19e9_b-800x540.jpg"
  }
  ...
  const internship = {
    ...
    buttonLink: "mailto:info@codigoecuador.com",
    image: 'https://www.wola.org/wp-content/uploads/2016/04/Diego-and-Interns-e1477074226989.jpg'
...
const entrepreneurship = {
  ...
  buttonLink:"/contact",
  image: "https://www.imf.org/external/pubs/ft/fandd/2019/03/images/032019/lagarde-600.jpg"
}
const entrepreneurship2 = {
  id: 3,
  title: "Encourage Entrepreneurship",
  subtitle: "One Step at a Time",
  description: "With our organization’s mission always in mind, we strive to find new strategies to reach our goal. To preserve Ecuador's beautiful culture of entrepreneurship, Código Ecuador works to tear down walls, pave roads to resources, and encourage women to build opportunity. Contact us to learn more about how we make this happen.",
...
export const activities = [programming, internship, entrepreneurship,entrepreneurship2]
