...
export const text =
  ...
  <>
    ...
    <p>We test new exercises, collect data, and see what best prepares our students for careers in technology. At Código Ecuador, we want to create an engaging learning environment that will instill in our students a creative passion for computer programming.</p>
