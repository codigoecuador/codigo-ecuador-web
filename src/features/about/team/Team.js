    ...
    return (
      <Container className='team center' justified>
        ...
        <div className='subhead'>
          Código Ecuador is developing through an extensive network of social
          activists and computer programming advocates. We’re very proud of the
          diversity of our partners, and their abilities to contribute their own
          unique experience and skills to our success. Find out more about some
